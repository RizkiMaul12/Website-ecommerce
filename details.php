              ...
              <form action="" method="post" class="form-horizontal"><!-- form-horizontal Starts -->
                ...
                ?>
                  ...
                  <div class="form-group"><!-- form-group Starts -->
                    ...
                    <label class="col-md-5 control-label">Product Jumlah </label>

                    <div class="col-md-7"><!-- col-md-7 Starts -->

                      <select name="product_qty" class="form-control">

                        <option>Select Jumlah</option>
                        <option>1</option>
                        <option>2</option>
                        <option>3</option>
                        <option>4</option>
                  ...
                  <div class="form-group"><!-- form-group Starts -->
                    ...
                    <label class="col-md-5 control-label">Product Bentuk</label>

                    <div class="col-md-7"><!-- col-md-7 Starts -->

                      <select name="product_size" class="form-control">

                        <option>Select bentuk</option>
                        <option>Bouquet</option>
                        <option>Bunga Papan</option>
                        <option>Ikebana</option>
                        <option>Flower Crown</option>
                ...
                <?php } else { ?>
                  ...
                  <div class="form-group"><!-- form-group Starts -->
                    ...
                    <label class="col-md-5 control-label">Bundle Jumlah </label>
...
Bayar : <del> Rp. $pro_price </del><br>

Sale : Rp. $pro_psp_price
...
Bundle bayar : <del> Rp. $pro_price </del><br>

Bundle sale  : Rp. $pro_psp_price
