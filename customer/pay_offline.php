    ...
    <table class="table table-bordered table-hover table-striped"><!-- table table-bordered table-hover table-striped Starts -->
        ...
        <tbody><!-- tbody Starts -->
            ...
            <tr>
                ...
                <td> Bank Name:BCA Account No:03333333 Branch Code:0342 Branch Name:DemoBranch </td>

                <td> NIC#001230006 Mobile No:7410000000, Name:DemoName </td>

                <td> Full Name:Demo Name, Mobile No:7000015000, Name:Demo, Country:Indonesia, N.I.C No:011234567
                </td>
