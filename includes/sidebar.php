    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data starts -->
        ...
        <div class="panel-body"><!-- panel-body Starts -->
            ...
            <div class="input-group"><!-- input-group Starts -->
                ...
                <input type="text" class="form-control" id="dev-table-filter" data-action="filter" data-filters="#dev-manufacturer" placeholder="Pencarian">
    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data Starts -->
        ...
        <div class="panel-body"><!-- panel-body Starts -->
            ...
            <div class="input-group"><!-- input-group Starts -->
                ...
                <input type="text" class="form-control" id="dev-table-filter" data-action="filter" data-filters="#dev-p-cats" placeholder="Pencarian">
    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data Starts -->
        ...
        <div class="panel-body"><!-- panel-body Starts -->
            ...
            <div class="input-group"><!-- input-group Starts -->
                ...
                <input type="text" class="form-control" id="dev-table-filter" data-action="filter" data-filters="#dev-cats" placeholder="Pencarian">
