          ...
          <div class="panel-body"><!-- panel-body Starts -->
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal Starts -->
              ...
              <div class="form-group"><!-- form-group Starts -->
                ...
                <label class="col-md-3 control-label"> Kinds of flowers </label>

                <div class="col-md-6">

                  <select class="form-control" name="manufacturer"><!-- select manufacturer Starts -->

                    <option> Select A Kinds of flowers </option>
...
$manufacturer_title
              ...
              <div class="form-group"><!-- form-group Starts -->
                ...
                <label class="col-md-3 control-label"> Types of flowers </label>

                <div class="col-md-6">

                  <select name="product_cat" class="form-control">

                    <option> Select a Types of flowers </option>
