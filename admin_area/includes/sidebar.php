            ...
            <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav Starts -->
                ...
                <li><!-- manufacturer li Starts -->
                    ...
                    <a href="#" data-toggle="collapse" data-target="#manufacturers"><!-- anchor Starts -->
                        ...
                        <i class="fa fa-fw fa-briefcase"></i> Kinds of flowers
                    ...
                    <ul id="manufacturers" class="collapse"><!-- ul collapse Starts -->
                        ...
                        <li>
                            <a href="index.php?insert_manufacturer"> Insert Kinds of flowers </a>
                        </li>

                        <li>
                            <a href="index.php?view_manufacturers"> View Kinds of flowers </a>
                        </li>
                ...
                <li><!-- li Starts -->
                    ...
                    <a href="#" data-toggle="collapse" data-target="#p_cat">
                        ...
                        <i class="fa fa-fw fa-pencil"></i> Types of flowers
                    ...
                    <ul id="p_cat" class="collapse">
                        ...
                        <li>
                            <a href="index.php?insert_p_cat"> Insert Types of flowers </a>
                        </li>

                        <li>
                            <a href="index.php?view_p_cats"> View Types of flowers </a>
                        </li>
